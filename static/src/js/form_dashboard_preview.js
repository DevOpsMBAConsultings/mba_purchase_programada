...
export class FormDashboardPreviewComponent extends Component {
  static template = "mba_bi_dashboard.formDashboardPreview";
  setup() {
    super.setup();
    ...
    this.state = useState({
      ...
      isDirty: false,
      data: {},
      theme: this.props.record.data.theme || "animated",
      recordSets: {},
    });
    ...
    useEffect(
      () => {
        ...
        this.state.theme = this.props.record.data.theme || "animated";
        this.isRecordDirty();
        let prepared_data = {
          name: this.props.record.data.name,

...
class ProfitAndLoss extends owl.Component {
    ...
    sumGrossProfit(op_inc, cor) {
        /**
         * Calculates the gross profit by summing operating income and cost of revenue.
         * Handles both string values (e.g. "1,234.56") and plain numbers (e.g. 1234.56).
         *
         * @param {string|number} op_inc - Operating income total.
         * @param {string|number} cor - Cost of revenue total.
         * @returns {number} The gross profit value.
         */
        const toFloat = (val) => {
        ...
        return toFloat(op_inc) + toFloat(cor);
    }

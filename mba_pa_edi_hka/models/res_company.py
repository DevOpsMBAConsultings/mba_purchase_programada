...
class ResCompany(models.Model):
    ...
    def action_hka_get_token(self):
        self.ensure_one()
        
        # Validación de expiración para evitar bloqueos:
        # Si tenemos token y aún le quedan más de 5 minutos de validez, no renovamos.
        if self.l10n_pa_hka_token and self.l10n_pa_hka_token_expires_at:

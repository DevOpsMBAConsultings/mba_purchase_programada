...
- Dependencias: `account`
- ℹ️ El repositorio de origen (`l10n_pa_simplificat`... perdón, `mba_reportes_diarios`) tiene una versión más reciente (18.0.1.3.16, con 5 reportes) que esta copia local — conviene actualizar el subtree pronto
